module.exports = (req, res, next) => {
    ...
    const {businessname, email, password, businessno, phone, state, city, address, postcode} = req.body;
    ...
    */
    if (req.path === "/register") {
      if (![businessname, email, password, businessno, phone, state, city, address, postcode].every(Boolean)) {
